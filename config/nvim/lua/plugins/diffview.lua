...
-- 	keys = {
-- 		{ "<leader>do", desc = "Open codediff against develop", "<cmd>CodeDiff origin/develop<cr>" },
-- 		{ "<leader>dv", desc = "Open codediff against HEAD", "<cmd>CodeDiff<cr>" },
-- 		{
-- 			"<leader>db",
...
-- 			end,
-- 		},
-- 		{ "<leader>dh", desc = "Show git history for currenty file", "<cmd>CodeDiff history %<cr>" },
-- 	},
-- 	opts = {},
-- }
